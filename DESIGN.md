...
- **Lenis smooth-scroll** (`components/providers/smooth-scroll.tsx`, Session 19 redo):
  ...
  Horizontal lanes carry `data-lenis-prevent` so trackpad gestures scroll the lane. **No snap.**

...
class CanvAscii {
  ...
  constructor(
    { text, asciiFontSize, textFontSize, textColor, planeBaseHeight, enableWaves, imageSrc }: CanvAsciiOptions,
  ...
  useEffect(() => {
    ...
    const createAndInit = async (container: HTMLDivElement, w: number, h: number) => {
      const instance = new CanvAscii(
        { text, asciiFontSize, textFontSize, textColor, planeBaseHeight, enableWaves, imageSrc },
        container,
        w,
        h
      );

...
export const PROBLEM_QA: ProblemQA[] = [
  ...
  },
  {
    ...
    a: 'A Web3 MVP (wallet integration, smart-contract logic, and a working frontend) ships in three to six weeks when one senior team owns architecture, engineering, and deployment continuously. Longer windows usually point to fragmented ownership across vendors or specifications that keep changing mid-build.',
  },
]

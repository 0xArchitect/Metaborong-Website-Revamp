  ...
  return (
    <section className="relative min-h-screen bg-bg-subtle">
      ...
      <div className="max-w-[1600px] mx-auto min-h-screen grid grid-cols-1 lg:grid-cols-[57fr_43fr]">
        {/* Left: copy — no Reveal wrap. The hero is always above the fold,
            so fading it in delays LCP and hides text from crawlers that
            don't run JS. */}
        <div className="flex flex-col justify-center pt-[80px] pb-[36px] lg:pt-[96px] lg:pb-[48px] px-[24px] md:px-[48px] lg:px-[96px] xl:px-[128px]">
